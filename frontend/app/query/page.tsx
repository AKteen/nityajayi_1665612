...
import {
  ...
  Upload, FileText, CheckCircle2, XCircle, X, MessageSquare, Hash, Mic, Image as ImageIcon,
} from "lucide-react";
import { queryKnowledge, ingestFile, ingestSlack, ingestAudio, ingestImage, type QueryResponse } from "@/lib/api";
...
type Tab = "query" | "upload" | "slack" | "audio" | "image";
